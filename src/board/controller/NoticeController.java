...
import notice.model.FactoryCommand;
...
public class NoticeController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println(cmd+"noticeCONTROLLER");
		...
		try {
			...
			System.out.println("NoticeController 에러 : "+e);
		}
	
		RequestDispatcher view = req.getRequestDispatcher("main/index.jsp");
		System.out.println(url+"noticeCONTROLLER URL");
