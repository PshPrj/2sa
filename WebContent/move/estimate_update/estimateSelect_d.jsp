...
<div class="span5" id="ver" style="background-color:#E5B1C5; height:20px; width:100px; margin-top:0px; align:left; margin-left:0px">견적 삭제</div>
<br/>
<form action="../eUpdate.do" name="form1" style="margin-left:0px" method="POST">
<input type="hidden" value="" name="estimate_board_num"/>
<input type="hidden" value="DELETE_S" name="cmd"/>
삭제하실 견적을 선택해 주세요.
...
<input class="btn btn-default btn-sm" value = "삭제" type="button" id="submit "style="font-family: 'Jeju Gothic', serif;" onclick="Datasubmit(this.form)"/>
</form>