...
function getData(form1){
	...
	if(($('#add2_el').is(":checked"))){
		element[i]= "[elY";
	}else{
		element[i]= "[elN";
	}
	
	if(($('#add2_parkinglot').is(":checked"))){
		element[i]+="pkY+";
	}else{
		element[i]+= "pkN+";
	}
...
<form method="POST" action="../eUpdate.do" name="form1">
	<input type="hidden" value="EU_7" name="cmd"/>
...
<div class="span2" style="background-color:#B2E0F0; margin-left:0px">현재 주소</div><br/>
&nbsp;&nbsp;&nbsp;
